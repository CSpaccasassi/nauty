...
extern FILE *opengraphfile(char*,int*,booleann,long);
...
extern graph *readgg(FILE*,graph*,int,int*,int*,booleann*);
extern graph *readggcrn(FILE*,graph*,int,int*,int*,booleann*,int);
extern graph *readg(FILE*,graph*,int,int*,int*);
extern graph *readgg_inc(FILE*,graph*,int,int*,int*,graph*,int,int,booleann*);
...
extern sparsegraph *read_sgg_loops(FILE*,sparsegraph*,int*,booleann*);
...
extern booleann strhaschar(char*,int);

extern void fcanonise(graph*,int,int,graph*,char*,booleann);
extern void fcanonise_inv
             (graph*,int,int,graph*,char*,void(*)(graph*,int*,int*,int,
               int,int,int*,int,booleann,int,int),int,int,int,booleann);
extern void fcanonise_inv_sg
           (sparsegraph*,int,int,sparsegraph*,char*,void(*)(graph*,int*,int*,
             int,int,int,int*,int,booleann,int,int),int,int,int,booleann);
...
extern void fgroup_inv
	     (graph*,int,int,char*,int*,int*,void(*)(graph*,int*,int*,int,
                int,int,int*,int,booleann,int,int),int,int,int);
...
extern TLS_ATTR booleann is_pipe;
