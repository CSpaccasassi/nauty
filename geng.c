...
OUTPROC feature.
   ...
   *g, int n). f is a stream open for writing, g is the graph in
   ...
   yformat and canonise (all type booleann) can be used to test
...
static booleann bipartite;       /* presence of -b */
static booleann trianglefree;    /* presence of -t */
static booleann squarefree;      /* presence of -f */
static booleann savemem;         /* presence of -m */
static booleann verbose;         /* presence of -v */
booleann nautyformat;            /* presence of -n */
booleann yformat;                /* presence of -y */
...
static void
makeleveldata(booleann restricted)
...
static booleann
accept1b(graph *g, int n, xword x, graph *gx, int *deg, booleann *rigid,
...
static void
spaextend(graph *g, int n, int *deg, int ne, booleann rigid,
...
static void
genextend(graph *g, int n, int *deg, int ne, booleann rigid, int xlb, int xub)
...
{
    char *arg;
    booleann badargs,gote,gotmr,gotf,gotd,gotD,gotx,gotX;
    booleann secret,connec1,connec2,safe,sparse;
    char *outfilename,sw;
    int i,j,argnum;
    graph g[1];
    int tmaxe,deg[1];
